    ...
    <div className='py-4'>
      ...
      <ul>
        <li className='py-2 pl-2'>
          <Link to={path.home} className='relative px-2 font-semibold text-lightBlue'>
        ...
        <form className='mt-3'>
          <div className='flex items-start'>
            <Input
              ...
              name='from'
              placeholder='₫ Từ'
              classNameInput='p-1 w-full outline-none border border-gray-300 focus:border-lightBlue rounded-sm focus:shadow-sm'
            />
