              ...
              <div className='col-span-6'>
                <div className='flex items-center'>
                  <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                    <input type='checkbox' className='h-5 w-5 accent-lightBlue' />
                  </div>
                ...
                >
                  ...
                  <div className='col-span-6'>
                    <div className='grid grid-cols-5 items-center'>
                      ...
                      <div className='col-span-1'>
                        <button className='bg-none text-black transition-colors hover:text-lightBlue'>Xóa</button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
            <div>
              <div className='flex items-center sm:justify-end'>
                ...
                <div className='ml-2 text-2xl text-lightBlue'>₫138000</div>
              </div>
              <div className='flex items-center text-sm sm:justify-end'>
                <div className='text-gray-500'>Tiết kiệm</div>
                <div className='ml-6 text-lightBlue'>₫138000</div>
              </div>
            </div>
            <Button className='mt-5 flex h-10 w-52 items-center justify-center bg-lightBlue text-sm uppercase text-white hover:bg-lightBlue/80 sm:ml-4 sm:mt-0'>
              Mua hàng
            </Button>
          </div>
        </div>
