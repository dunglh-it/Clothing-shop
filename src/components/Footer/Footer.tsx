      ...
      <div className='container'>
        <div className='grid grid-cols-4 py-10'>
          <div className='col-span-1'>
            <h4 className='text-sm font-semibold uppercase'>{t('take care.customer service')}</h4>

            <ul className='mt-5 text-[12px] capitalize text-neutral-600'>
              <li className='mb-2 pb-1 hover:text-lightBlue'>
          ...
          <div className='col-span-1'>
            <h4 className='text-sm font-semibold uppercase'>{t('about of.about')}</h4>
          ...
          <div className='col-span-1'>
            <h4 className='text-sm font-semibold uppercase'>{t('about of.follow')}</h4>

            <ul className='mt-5 text-[12px] capitalize text-neutral-600'>
              <li className='mb-2 pb-1 hover:text-lightBlue'>
                <Link to='/' className='flex items-center'>
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' className='mr-2 h-4 w-4'>
              ...
              <li className='mb-2 pb-1 hover:text-lightBlue'>
                <Link to='/' className='flex items-center'>
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='mr-2 h-4 w-4'>
          ...
          <div className='col-span-1'>
            <h4 className='text-sm font-semibold uppercase'>{t('about of.download app')}</h4>

            <div className='mt-5 inline-block rounded-md border bg-white px-4 py-2 shadow-sm'>
              <Link to='/'>
